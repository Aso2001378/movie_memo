...
<h1>新規登録</h1>
<div class="text">
<p>※ユーザー名(英数字4~12文字以内)</p>
<p>※パスワード(英数字4~8文字以内)</p>
<p>※メールアドレスは登録後、変更できません</p>
</div>
<?php
...
<form method="post">
<!-- 英数字4~12文字以内 -->
<input type="text" class="input" name="user_name" value="" pattern="[0-9A-Za-z0-9]{4,12}"  placeholder="ユーザー名" required><br>
<!-- 英数字4~8文字以内 -->
<input type="password" class="input" name="password_01" value="" pattern="[0-9A-Za-z0-9]{4,8}" placeholder="パスワード" required><br>
<input type="password" class="input" name="password_02" value="" pattern="[0-9A-Za-z0-9]{4,8}" placeholder="パスワード(確認用)" required><br>
<!-- 普通の形式 -->
<input type="email" class="input" name="mail" value="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" placeholder="メールアドレス" required><br>
