...
<div class="login">
    <p>ユーザー名</p>
    <p class="content"><input type="text" name="user_name"  value="" placeholder="入力してください" required></p>
    <p>パスワード</p>
    <p class="content"><input type="password" name="password" value="" placeholder="入力してください" required></p>
