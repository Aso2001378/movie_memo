...
<div class="login">
    ...
    <p class="content"><input type="text" name="user_name" id="user" value="meetboy" placeholder="入力してください" required></p>
    <label for="password"><p>パスワード</p></label>
    <p class="content"><input type="password" name="password" id="password" value="12345" placeholder="入力してください" required></p>
